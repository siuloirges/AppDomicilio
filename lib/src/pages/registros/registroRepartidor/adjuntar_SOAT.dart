...
class AdjuntarSOATPage extends StatefulWidget {
  @override
  _AdjuntarSOATPage createState() => _AdjuntarSOATPage();
}

class _AdjuntarSOATPage extends State<AdjuntarSOATPage> {
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      fotos.getSoatParteTrasera == null
                          ? addImage(fotos.getSoatParteTrasera)
                          : image(fotos.getSoatParteTrasera),
                      ClipRRect(
                      ...
                      fotos.getSoatParteFrontal == null
                          ? addImage(fotos.getSoatParteFrontal)
                          : image(fotos.getSoatParteFrontal),
                      ClipRRect(
                          borderRadius: BorderRadius.only(bottomLeft:Radius.circular(20),bottomRight: Radius.circular(20) ),
                          child: Container(
                              color: verde,
              ...
              children: <Widget>[
                Container(
                    child: RaisedButton(
                        ...
                        onPressed: () {
                          if (foto == fotos.getSoatParteTrasera) {
                            cargarImageCamera(foto);
                            Navigator.pop(context);
                          } else if (foto == fotos.getSoatParteFrontal) {
  ...
  Future cargarImageGalery(File foto) async {
    ...
    setState(() {
      fotos.setSoatParteTrasera = tempImage;
    });
  }
  ...
  Future cargarImageCamera(File foto) async {
    ...
    setState(() {
      fotos.setSoatParteTrasera = tempImageCamera;
    });
  }
  ...
  Future cargarImageGalery2(File foto) async {
    ...
    setState(() {
      fotos.setSoatParteDelantera = tempImage;
    });
  }
  ...
  Future cargarImageCamera2(File foto) async {
    ...
    setState(() {
      fotos.setSoatParteDelantera = tempImageCamera;
    });
  }
}
