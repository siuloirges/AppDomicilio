...
class ActualizarAliado extends StatefulWidget {
  const ActualizarAliado({Key key}) : super(key: key);

  @override
  _ActualizarAliadoState createState() => _ActualizarAliadoState();
}

class _ActualizarAliadoState extends State<ActualizarAliado> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            SizedBox(height: _size.height * 0.05),
            // consulta == true
            //     ? _movimientos(context: context, productos: '55')
            //     : Container(),
            consulta == true
              ? GestureDetector(
                  onTap: () {
                    showDialog(
                      ...
                      builder: (context) => SingleChildScrollView(
                        child: alertActualizarAliado(context: context, productos: '65'),
                      ),
                    );
                  },
                  child: PruebaWidget(
  ...
  Widget alertActualizarAliado({BuildContext context , String productos } ){
    final _size = MediaQuery.of(context).size;
    return AlertDialog(
                  ...
                  Container(
                      ...
                      child: RaisedButton(
                          ...
                          onPressed: () {
                            ...
                            Navigator.of(context).pushNamed('CearAliadoAdmin');
                          },
                          shape: StadiumBorder(),
