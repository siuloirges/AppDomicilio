...
class ConsultarClienteAdministrador extends StatefulWidget {
  const ConsultarClienteAdministrador({Key key}) : super(key: key);

  @override
  _ConsultarClienteAdministradorState createState() =>
      _ConsultarClienteAdministradorState();
}

class _ConsultarClienteAdministradorState
    extends State<ConsultarClienteAdministrador> {
                    ...
                    onTap: () {
                      showDialog(
                        ...
                        builder: (context) => SingleChildScrollView(
                          child: alertConsultarCliente(context),
                        ),
                      );
                    },
                    child: PruebaWidget(
  ...
  Widget alertConsultarCliente(BuildContext context) {
    final _size = MediaQuery.of(context).size;
