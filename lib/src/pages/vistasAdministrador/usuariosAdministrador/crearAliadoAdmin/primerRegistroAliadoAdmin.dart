...
class PrimerRegistroAliadoAdmin extends StatefulWidget {
  @override
  _PrimerRegistroAliadoAdminState createState() =>
      _PrimerRegistroAliadoAdminState();
}

class _PrimerRegistroAliadoAdminState extends State<PrimerRegistroAliadoAdmin> {
  Size size;
                      ...
                      child: guardarEstado.getFotoPerfilAliado != null
                          ? ClipRRect(
                              ...
                              child: Image(
                                  fit: BoxFit.cover,
                                  image: FileImage(
                                      guardarEstado.getFotoPerfilAliado)),
                            )
                          : null),
                ),
              ),
              guardarEstado.getFotoPerfilAliado != null
                  ? Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      RaisedButton(
                        ...
                        onPressed: () {
                          onpressaddImage(
                              context, guardarEstado.getFotoPerfilAliado);
                        },
                        child: Row(
          ...
          child: Stack(
            children: [
                      ...
                      child: guardarEstado.getFotoPortadaAliado != null
                          ? ClipRRect(
                              ...
                              child: Image(
                                  fit: BoxFit.cover,
                                  image: FileImage(
                                      guardarEstado.getFotoPortadaAliado)),
                            )
                          : null),
                ),
              ),
              guardarEstado.getFotoPerfilAliado != null
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          RaisedButton(
                            ...
                            onPressed: () {
                              onpressaddImage(
                                  context, guardarEstado.getFotoPortadaAliado);
                            },
                            child: Container(
                              width: 100,
                              child: Center(
                  ...
                  : Container(),
              guardarEstado.getFotoPortadaAliado != null
                  ? Row(
                      mainAxisAlignment: MainAxisAlignment.end,
                      children: [
                        Center(
              ...
              onPressed: () async {
                ...
                if (guardarEstado.getFotoPerfilAliado == null) {
                  return alerta(context,
                      code: false,
                      contenido: 'El logo del aliado es necesario');
                }

                if (guardarEstado.getFotoPortadaAliado == null) {
                  return alerta(context,
                      code: false,
                      contenido: 'La foto de portada es necesaria');
                }
                // print('id aliado ' + usuarioProvider.getIdAliado.toString());

                // Navigator.of(context)
                //     .pushNamed('SegundaPaginaCrearAliadoAdmin');
                load(context);
                usuarioProvider.obetenerDatos(context,
                    ruta: 'SegundaPaginaCrearAliadoAdmin',
                    // ruta: 'RegistroAliado',
