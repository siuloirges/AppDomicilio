...
class MisOrdenesAliado extends StatefulWidget {
  MisOrdenesAliado({Key key}) : super(key: key);

  @override
  _MisOrdenesAliadoState createState() => _MisOrdenesAliadoState();
}

class _MisOrdenesAliadoState extends State<MisOrdenesAliado> {
  ...
  PedidoAliadoProvider pedido;
  @override
  Widget build(BuildContext context) {
    pedido = Provider.of<PedidoAliadoProvider>(context);
    _pref.activo='true';
    ...
    ruta =  element['aliado']?"aliado_id=${_pref.id_aliado}":"sucursal_id=${_pref.id_sucursal}";
...
class ModuleState extends State<Module> {
  ...
  pedir()async{
    ...
    if(_resp['message']=='true'){
      ...
      try{
        respPedidosAliado = respPedidosAliadoFromJson(_resp['resp']);
      }catch(error){
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text('Autorizar',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                  ),
                  ...
                  child: Row(
                   ...
                   children: [
                       ...
                       child: Column(
                         ...
                         children: [
                           Container(
                             ...
                             child: Text('Cliente: ${element.cliente.nombre}',style: TextStyle(fontSize: 17,color:negro,fontWeight: FontWeight.bold) ,maxLines: 1),),
                           Container(
                           width: 150,
                           // color: Colors.redAccent,
                           child: Text('ID: ${element.numeroPedido}',style: TextStyle(fontSize: 10,color:verde,fontWeight: FontWeight.bold) ,maxLines: 1),),
                           
                           Container(
                               
                               width: 150,
                               // color: Colors.redAccent,
                               child: Text('${element.direccion.direccion}',style: TextStyle(fontSize: 10,color:Color.fromRGBO(index+index, 111, index*03, 0.5)),maxLines: 2),),
                         ],
                       ),
                     ),
                     Padding(
                     ...
                     GestureDetector(
                       onTap: (){
                         pedido.reload();
                         Navigator.pushNamed(context, 'detallesDeOrdenAliado',arguments: {
                         "orden":element
                       });
                       },
                       child: Padding(
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text('Preparada',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                  ),
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            width: 150,
                            // color: Colors.redAccent,
                            child: Text('Cliente: ${element.cliente.nombre}',style: TextStyle(fontSize: 17,color:negro,fontWeight: FontWeight.bold),overflow:TextOverflow.ellipsis ,maxLines: 1),),
                          Container(
                            width: 150,
                            // color: Colors.redAccent,
                            child: Text('ID: ${element.numeroPedido}',style: TextStyle(fontSize: 10,color:verde,fontWeight: FontWeight.bold),overflow:TextOverflow.ellipsis ,maxLines: 1),),
                          
                          Container(
                            width: 150,
                            // color: Colors.redAccent,
                            child: Text('${element.direccion.direccion}',style: TextStyle(fontSize: 10,color:Color.fromRGBO(index+index, 111, index*03, 0.5)),overflow:TextOverflow.ellipsis ,maxLines: 2),),
                        ],
                      ),
                    ),
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            width: 90,
                            child: Text('${element.metodoDePago}',textAlign: TextAlign.center,style: TextStyle(fontSize: 8,color:negro),maxLines: 2,)),
                        ],
                      ),
                    ),
                    GestureDetector(
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: (){
                      return alerta(context,code: true,
                      titulo: 'Buscar repartidor',
                       contenido:Column(
                        children: [
                          Text('Esta opcion le permite notificar a todos los repartidores disponibles.',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16,color: Colors.grey)),
                          Text('\nnota: usted sera notificado cuando un repartidor acepte el cargo del pedio.',style: TextStyle(fontSize: 12),)
                        ],
                      ),
                      acciones: Column(
                        children: [
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: RaisedButton(
                              child: Text('Buscar repartidor',style: TextStyle(color: Colors.white),),
                              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(100),),
                              color:Color.fromRGBO(index+index, 181, index*03, 1),
                              onPressed: ()async{
                                ...
                                Navigator.pop(context);
                                   ...
                                   if(_resp['message']=='true'){
                                    ...
                                    alerta(context,code: false,contenido: 'Todos los repartidores activos han sido notificados correctamente');
                                   }
                              }),
                          ),
                          Padding(
                            ...
                            child: FlatButton(onPressed: ()async{
                                ...
                                Navigator.pop(context);
                                   ...
                                   if(_resp['message']=='true'){
                                    ...
                                    Navigator.pop(context);
                                     ...
                                     child: Text('si',style: TextStyle(color:verde),)
                              ...
                              },child: Text('Ya tengo un repartidor',style: TextStyle(color: Colors.blueGrey),)),
                          ),
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        width: 50,
                        height: 50,
                        child: Icon(Icons.schedule_send,color: Colors.white,),
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(100),
                        color: Color.fromRGBO(index+index, 181, index*03, 0.5)
                        )
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          width: 150,
                          // color: Colors.redAccent,
                          child: Text('Cliente: ${element.cliente.nombre}',style: TextStyle(fontSize: 17,color:negro,fontWeight: FontWeight.bold),maxLines: 2),),
                        Container(
                          width: 150,
                          // color: Colors.redAccent,
...
class PedidoAliadoProvider extends ChangeNotifier{
