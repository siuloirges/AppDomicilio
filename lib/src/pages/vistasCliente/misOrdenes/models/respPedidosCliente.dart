...
//
//     final respPedidosCliente = respPedidosClienteFromJson(jsonString);

import 'dart:convert';

RespPedidosCliente respPedidosClienteFromJson(String str) =>
    RespPedidosCliente.fromJson(json.decode(str));

String respPedidosClienteToJson(RespPedidosCliente data) =>
    json.encode(data.toJson());

class RespPedidosCliente {
  RespPedidosCliente({
    this.success,
    this.data,
    this.message,
  ...
  factory RespPedidosCliente.fromJson(Map<String, dynamic> json) =>
      RespPedidosCliente(
...
class Sucursal {
  ...
  factory Sucursal.fromJson(Map<String, dynamic> json) => Sucursal(
        ...
        createdAt: DateTime.parse(json["created_at"]),
        updatedAt: DateTime.parse(json["updated_at"]),
        idAsistente: json["id_asistente"] == null ? null : json["id_asistente"],
        idAliado: json["id_aliado"],
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "created_at": createdAt.toIso8601String(),
        "updated_at": updatedAt.toIso8601String(),
        "id_asistente": idAsistente == null ? null : idAsistente,
        "id_aliado": idAliado,
      };
}
