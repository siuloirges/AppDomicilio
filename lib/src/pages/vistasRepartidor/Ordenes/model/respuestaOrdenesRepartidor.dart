...
//
//     final RespPedidosRepartidor = respPedidosRepartidor(jsonString);

import 'dart:convert';

RespPedidosRepartidor respPedidosRepartidor(String str) =>
    RespPedidosRepartidor.fromJson(json.decode(str));

String respPedidosAliadoToJson(RespPedidosRepartidor data) =>
    json.encode(data.toJson());

class RespPedidosRepartidor {
  RespPedidosRepartidor({
    this.success,
    this.data,
    this.message,
  });
  ...
  factory RespPedidosRepartidor.fromJson(Map<String, dynamic> json) =>
      RespPedidosRepartidor(
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        repartidorId: json["repartidor_id"] == null
            ? null
            : int.parse(json["repartidor_id"].toString()),
